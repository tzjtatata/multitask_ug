...
import numpy as np
from lightning.data.panoptic_parts.utils import _sparse_ids_mapping_to_dense_ids_mapping as ndarray_from_dict
import torch

from lightning.data.panoptic_parts.dataset_spec import DatasetSpec
...
from lightning.data.panoptic_parts.utils import _parse_sid_group
