...
def hrnet_w18(pretrained=False):
    ...
    hrnet_cfg = os.path.join(PROJECT_ROOT_DIR, 'configs', 'hrnet_w18.yml')
    ...
    if pretrained:
        pretrained_weights = os.path.join(PROJECT_ROOT_DIR, 'pretrain_model', 'hrnet_w18_small_model_v2.pth')
